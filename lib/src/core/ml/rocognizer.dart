...
import 'package:flutter_absensi_app/src/data/datasource/local_datasource.dart';
...
class Recognizer {
  ...
  Future<bool> isValidFace(List<double> emb) async {
    final authData = LocalDataSourceImpl().getUser();
    final faceEmbedding = authData?.faceEmbedding;
